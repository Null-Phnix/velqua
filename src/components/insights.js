...
export async function loadInsights() {
    ...
    try {
        ...
        errDiv.textContent = 'Failed to load insights: ' + error.message;
...
function _makeBar(label, count, maxCount) {
...
async function loadQualityInsights(container) {
    try {
...
async function loadGraphInsights(container) {
    try {
...
async function loadEmotionalInsights(container) {
    try {
